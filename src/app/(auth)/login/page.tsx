...
import { z } from 'zod'
import { Eye, EyeOff, Mail, Lock, Loader2, Building2, Zap } from 'lucide-react'
    ...
    >
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg bg-white text-slate-800 font-medium text-sm hover:bg-slate-100 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {oauthLoading === 'google' ? (
        ...
        <button
          ...
          disabled={!!oauthLoading || isSubmitting}
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg bg-[#0078d4] text-white font-medium text-sm hover:bg-[#006bbf] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {oauthLoading === 'azure' ? (
            <Loader2 className="w-5 h-5 animate-spin" />
          ) : (
